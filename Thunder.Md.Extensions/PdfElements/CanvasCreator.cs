...
public delegate bool InlineCanvasCreatorMethod(ExtensionArgs args, string url, ITextElement? altText, [NotNullWhen(true)] out IInlineCanvasElement? inlineCanvas);
